...
const (
	IndexConstraintEq        = uint8(C.SQLITE_INDEX_CONSTRAINT_EQ)
	IndexConstraintGt        = uint8(C.SQLITE_INDEX_CONSTRAINT_GT)
	IndexConstraintLe        = uint8(C.SQLITE_INDEX_CONSTRAINT_LE)
	IndexConstraintLt        = uint8(C.SQLITE_INDEX_CONSTRAINT_LT)
	IndexConstraintGe        = uint8(C.SQLITE_INDEX_CONSTRAINT_GE)
	IndexConstraintMatch     = uint8(C.SQLITE_INDEX_CONSTRAINT_MATCH)
	IndexConstraintLike      = uint8(C.SQLITE_INDEX_CONSTRAINT_LIKE)
	IndexConstraintGlob      = uint8(C.SQLITE_INDEX_CONSTRAINT_GLOB)
	IndexConstraintRegExp    = uint8(C.SQLITE_INDEX_CONSTRAINT_REGEXP)
	IndexConstraintNe        = uint8(C.SQLITE_INDEX_CONSTRAINT_NE)
	IndexConstraintIsNot     = uint8(C.SQLITE_INDEX_CONSTRAINT_ISNOT)
	IndexConstraintIsNotNull = uint8(C.SQLITE_INDEX_CONSTRAINT_ISNOTNULL)
	IndexConstraintIsNull    = uint8(C.SQLITE_INDEX_CONSTRAINT_ISNULL)
	IndexConstraintIs        = uint8(C.SQLITE_INDEX_CONSTRAINT_IS)
	IndexConstraintLimit     = uint8(C.SQLITE_INDEX_CONSTRAINT_LIMIT)
	IndexConstraintOffset    = uint8(C.SQLITE_INDEX_CONSTRAINT_OFFSET)
	IndexConstraintFunction  = uint8(C.SQLITE_INDEX_CONSTRAINT_FUNCTION)
	IndexScanUnique          = uint8(C.SQLITE_INDEX_SCAN_UNIQUE)
)
